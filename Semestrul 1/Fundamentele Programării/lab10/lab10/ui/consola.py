...
class Consola:
    ...
    def afisare_meniu(self):
        ...
        print('10. Generarea a [n] persoane')
        print('17. Adaugare by default')
        print('17.1. Adaugare by default persoane')
        print('17.2. Adaugare by default evenimente')
    def optiune(self):
        '''
            ...
            if self.prima_optiune(lista_optiuni) == 1:
                if self.adoua_optiune(lista_optiuni) == 1:
                    try:
                        ...
                        self.__lista_persoane.__repo_persoane.adauga_by_default_persoane()
                ...
                n = int(input('Introduceti numarul de persoane pe care doriti sa le generati folosind functia RANDOM\n'))
                self.__lista_persoane.adauga_random(n, 0)
                self.afisare_lista_persoane(self.__lista_persoane.get_persoane())

            elif self.prima_optiune(lista_optiuni) == 17:
                if self.adoua_optiune(lista_optiuni) == 1:
