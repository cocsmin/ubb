...
public class ClientJsonWorker : IProjectObserver
{
    ...
    public ClientJsonWorker(IProjectServices server, TcpClient connection)
    {
        this.server = server;
    ...
    public virtual void Run()
    {
        ...
        while (connected)
        {
            try
            {
                ...
                Request request = JsonSerializer.Deserialize<Request>(requestJson, JsonOpts);
